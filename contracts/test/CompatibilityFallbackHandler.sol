...
interface ISignatureValidator {
     ...
     */
    function isValidSignature(bytes memory _data, bytes calldata _signature) external view returns (bytes4);
}

/// @notice Copy of Gnosis Safe v1.3.0 contract for compilation simplicity
