...
async function main() {
    ...
    const agentRegistry = await AgentRegistry.connect(EOA).deploy("Agent registry", "AGENT",
        "https://localhost/agents/", componentRegistryAddress);
    ...
    if (parsedData.contractVerification) {
        ...
        execSync("npx hardhat verify --constructor-args scripts/deployment/verify_02.js --network " + providerName + " " + agentRegistry.address, { encoding: "utf-8" });
    }
