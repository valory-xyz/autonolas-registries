...
echo "${green}Change ServiceManager implementation in its proxy${reset}"
castArgs="$serviceManagerProxyAddress setOperatorWhitelist(address) $operatorWhitelistAddress"
echo $castArgs
