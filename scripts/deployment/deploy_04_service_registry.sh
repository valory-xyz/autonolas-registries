...
constructorArgs="$serviceRegistryName $serviceRegistrySymbol $baseURI $agentRegistryAddress"
...
if [ "$contractVerification" == "true" ]; then
  contractParams="$serviceRegistryAddress $contractPath --constructor-args $(cast abi-encode "constructor(string,string,string,address)" "$serviceRegistryName" "$serviceRegistrySymbol" "$baseURI" "$agentRegistryAddress")"
