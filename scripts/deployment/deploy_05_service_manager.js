...
async function main() {
    ...
    console.log("5. EOA to deploy ServiceManager");
    ...
    if (parsedData.contractVerification) {
        ...
        execSync("npx hardhat verify --constructor-args scripts/deployment/verify_05.js --network " + providerName + " " + serviceManager.address, { encoding: "utf-8" });
    }
