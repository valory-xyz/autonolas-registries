...
castArgs="$serviceRegistryAddress changeManager(address) $serviceManagerAddress"
echo $castArgs
castCmd="$castSendHeader $castArgs"
result=$($castCmd)
echo "$result" | grep "status"

echo "${green}Change manager for ServiceRegistryTokenUtility${reset}"
castArgs="$serviceRegistryTokenUtilityAddress changeManager(address) $serviceManagerAddress"
echo $castArgs
castCmd="$castSendHeader $castArgs"
result=$($castCmd)
echo "$result" | grep "status"
