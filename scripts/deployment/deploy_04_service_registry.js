...
async function main() {
    ...
    const serviceRegistry = await ServiceRegistry.connect(EOA).deploy("Service registry", "SERVICE",
        "https://localhost/services/", agentRegistryAddress);
    ...
    if (parsedData.contractVerification) {
        ...
        execSync("npx hardhat verify --constructor-args scripts/deployment/verify_04.js --network " + providerName + " " + serviceRegistry.address, { encoding: "utf-8" });
    }
