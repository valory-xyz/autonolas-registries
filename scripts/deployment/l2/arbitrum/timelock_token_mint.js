...
const main = async () => {
   ...
   */
    ...
    const l2CallValue = 0;
    // const l2CallValue = ethers.utils.parseUnits("0.0000001");
    ...
    const timeloclCalldata = iface.encodeFunctionData("createRetryableTicket", [l2CallValue.address, l2CallValue,
