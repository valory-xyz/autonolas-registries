...
echo "${green}Change StakingVerifier ownership${reset}"
castArgs="$stakingVerifierAddress changeOwner(address) $bridgeMediatorAddress"
echo $castArgs
castCmd="$castSendHeader $castArgs"
result=$($castCmd)
echo "$result" | grep "status"

echo "${green}Change StakingFactory ownership${reset}"
castArgs="$stakingFactoryAddress changeOwner(address) $bridgeMediatorAddress"
echo $castArgs
castCmd="$castSendHeader $castArgs"
result=$($castCmd)
echo "$result" | grep "status"
