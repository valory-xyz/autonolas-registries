...
echo "${green}Change IdentityRegistryBridger implementation in its proxy${reset}"
castArgs="$identityRegistryBridgerProxyAddress changeImplementation(address) $identityRegistryBridgerAddress"
echo $castArgs
